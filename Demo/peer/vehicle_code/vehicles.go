...
//==============================================================================================================================
//	  - Retrieves the username of the user who invoked the chaincode.
...
func (t *SimpleChaincode) get_caller_data(stub *shim.ChaincodeStub) (string, int, error){
    ...
    fmt.Printf("get_caller_data %v %v \n", user, err)
																		if err != nil { return "", -1, err }

	ecert, err := t.get_ecert(stub, user);
    fmt.Printf("gat_caller_data %v %v \n", ecert, err)
																if err != nil { return "", -1, err }
